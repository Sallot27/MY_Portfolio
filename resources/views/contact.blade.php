                        ...
                        <div class="space-y-6">
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-white/90">sultan@example.com</p>
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-white/70 mt-1">Available 9AM - 5PM AST, Monday to Friday</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <div class="flex space-x-4">
                                        ...
                                        <a href="https://twitter.com/yourusername" target="_blank" rel="noopener noreferrer" class="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-white/20 transition-colors">
